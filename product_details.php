...
$select = "SELECT * FROM products join categories on products.product_subcategory=categories.cat_id where product_id = " . $_GET['product_id'];
$product = mysqli_query($connect, $select);
...
<div id="Wrapper">
    ...
    <div id="Content" class="product_details">
        <div class="content_wrapper clearfix">
            <div class="sections_group">
                <div class="entry-content">
                    <div class="section mcb-section"
                         style="padding-top:50px; padding-bottom:50px; background-color:#f8f8f8">
                        <div class="section_wrapper mcb-section-inner">
                            <div class="wrap mcb-wrap one valign-top clearfix">
                                <div class="mcb-wrap-inner">
                                    <div class="column mcb-column one column_column">
                                        <div class="column_attr clearfix align_center">
                                            <h6 class="themecolor"><?= $product['category_name'] ?></h6>
                                        ...
                                        <div
                                            ...
                                            <div class="image_wrapper" style="display: none">
                                                <img class="scale-with-grid"
                                                     src="admin/assets/images/category/<?= $product['category_image'] ?>">
                                            </div>
                    ...
                    <div class="section mcb-section equal-height-wrap" style="padding-top:30px; padding-bottom:30px">
                        <div class="section_wrapper mcb-section-inner">
                                    ...
                                    <div class="column mcb-column one column_column">
                                        <div class="column_attr clearfix" style="padding:0 10% 0 0">
                                            ...
                                            <a class="button  button_right button_size_2 button_theme button_js kill_the_icon"
                                               href="#">
                                                <span class="button_icon"><i class="icon-right-open-big"></i></span>
                                                <span class="button_label">Info Descrição</span>
                                            </a>
                    ...
                    if ($product['other_image'] != "" && $product['subtitle'] != "" && $product['title'] != "" && $product['description'] != "") {
                        ?>
                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_image">
                                            <div
                                                ...
                                                <div class="image_wrapper">
                                                    <img class="scale-with-grid"
                                                         src="admin/assets/images/products/<?= $product['other_image'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_column">
                                            <div class="column_attr clearfix" style="padding:0 0 0 10%">
                                                <h6 class="themecolor"><?= $product['subtitle'] ?></h6>
                                                <h3> <?= $product['title'] ?></h3>
                                                <hr class="no_line" style="margin:0 auto 15px">
                                                <?= $product['description'] ?>
                                            </div>
                    ...
                    if ($product['related_projects'] != "") {

                        ?>
                        <div class="section mcb-section"
                             style="padding-top:110px; padding-bottom:80px; background-color:#fff">
                            <div class="section_wrapper mcb-section-inner">
                                <div class="wrap mcb-wrap one valign-top clearfix">
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_column">
                                            <div class="column_attr clearfix align_center">
                                                <h6 class="themecolor">PROJECTOS</h6>
                                                <h3> <?= $product['product_name'] ?></h3>
                                            </div>
                                        </div>
                                        <div class="column mcb-column one column_image_gallery ">
                                            ...
                                            <div id='sc_gallery-1'
                                                ...
                                                $related_projects = $product['related_projects'];

                                                $related_projects = json_decode($related_projects);

                                                foreach ($related_projects as $key => $value) {
                                                    $select = "SELECT project_image, project_name from projects where project_id = " . $value;

                                                    $project_img = mysqli_query($connect, $select);

                                                    $project_img = mysqli_fetch_assoc($project_img);
                                                    ?>


                                                    <dl class='gallery-item'>
                                                        <dt class='gallery-icon landscape'>
                                                            <a href='admin/assets/images/projects/<?= $project_img['project_image'] ?>'>
                                                                <img
                                                                    src="admin/assets/images/projects/<?= $project_img['project_image'] ?>"
                                                                    class="attachment-thumbnail size-thumbnail">
                                                            </a>
                                                        <p style="margin-top: 20px"><?= $project_img['project_name'] ?></p>
                                                        </dt>
                                                    </dl>
