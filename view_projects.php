...
$select = "SELECT * FROM projects join categories on projects.project_subcategory=categories.cat_id where project_subcategory = " . $_GET['subcategory'];

$projects = mysqli_query($connect, $select);
                                                            ...
                                                            <li class="isotope-item post-96 product type-product has-post-thumbnail product_cat-amplifiers product_cat-headphones <?php echo($i % 2 == 0 ? '' : 'first'); ?> instock downloadable shipping-taxable purchasable product-type-simple">
                                                                <div
                                                                    ...
                                                                    <div class="image_wrapper">
                                                                        <a href="project_details.php?project_id=<?= $project['project_id'] ?>">
                                                                            <div class="mask"></div>
                                                                    ...
                                                                    <a href="project_details.php?project_id=<?= $project['project_id'] ?>"><span
                                                                            class="product-loading-icon added-cart"></span></a>
                                                                </div>
                                                                <div class="desc">
                                                                    <h4>
                                                                        <a href="project_details.php?project_id=<?= $project['project_id'] ?>"
                                                                           style="padding-bottom:15px; border-bottom: 1px solid #d4d4d4;"> <?= $project['project_name'] ?>
